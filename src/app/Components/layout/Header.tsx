...
//         <div className={`hidden md:block bg-[rgb(0,58,102)] bg-opacity-50 px-14 py-2 transition-all duration-300 ${isSticky ? 'hidden' : 'block'}`}>
//           <div className="mx-auto flex justify-between items-center text-sm text-[#a9a9a9a9]">
...
//         {/* Main Navigation */}
//         <nav className="bg-[#F5F5F5] px-4 sm:px-14 py-2">
...
//                 );
//               })}
//               <Link href="/services" className="bg-[#E02454] text-white font-semibold px-6 py-2 rounded-full hover:bg-opacity-80 transition-opacity duration-300">
//                 Get A Quote
//               </Link>
//             </div>
...
//       {/* Menu Panel */}
//       <div
//         className={`fixed top-0 right-0 h-full w-3/4 max-w-sm bg-white z-50 shadow-lg
